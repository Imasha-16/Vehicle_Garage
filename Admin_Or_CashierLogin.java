...
public class Admin_Or_CashierLogin extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Admin_Or_Seller
     */
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if ("Administrator".equals(cmbrole.getSelectedItem()) ) {
            new Admin_Login().setVisible(true); // Open Main_Menu
            this.dispose(); // Close the current form
        } else if ("Cashier".equals(cmbrole.getSelectedItem())) {
            new Cashier_Login().setVisible(true); // Open Main_Menu
            this.dispose();
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
         new Start_Menu().setVisible(true); // Open Main_Menu
            this.dispose();
